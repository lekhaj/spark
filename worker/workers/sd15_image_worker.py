...
# huchenlei/animal_openpose no longer exists on HF — fall back to openpose for quadrupeds
# The quad skeleton image already provides the structural guidance
CONTROLNET_ANIMAL_ID   = "lllyasviel/control_v11p_sd15_openpose"
