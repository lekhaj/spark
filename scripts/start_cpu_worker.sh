...
export REDIS_BROKER_URL="${REDIS_BROKER_URL:-redis://13.201.23.51:6379/0}"
export REDIS_RESULT_BACKEND="${REDIS_RESULT_BACKEND:-redis://13.201.23.51:6379/0}"
...
export GPU_SPOT_INSTANCE_IP="${GPU_SPOT_INSTANCE_IP:-13.201.23.51}"
