...
export REDIS_BROKER_URL="${REDIS_BROKER_URL:-redis://65.2.83.229:6379/0}"
export REDIS_RESULT_BACKEND="${REDIS_RESULT_BACKEND:-redis://65.2.83.229:6379/0}"
...
export GPU_SPOT_INSTANCE_IP="${GPU_SPOT_INSTANCE_IP:-65.2.83.229}"
