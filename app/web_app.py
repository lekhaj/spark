...
# Note: The following imports are not from the provided files, but are
# necessary to make the Gradio web app functional with the FastAPI backend
# as it would be in a real-world scenario.
import requests
import os
...
API_BASE_URL = "http://15.206.99.66:8000"

# --- DATABASE INTERACTION FUNCTIONS (unchanged) ---

# ... [The existing database functions like get_db_client, get_database_names, etc., are unchanged. 
# They are omitted here for brevity to focus on the new section.] ...
...
# ... [The existing UI logic functions like update_collections_dropdown, load_biome_pipeline_live, etc., are unchanged.
