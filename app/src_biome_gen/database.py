...
def save_biome_document(biome_doc: dict) -> str | None:
    ...
    Persist the document to MongoDB using an upsert. Returns the inserted id
    on insert, "updated" when an existing document was modified, "no_change"
    when nothing was changed, or None on failure.
    """
